...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      <div className="relative min-h-[70vh] md:min-h-[80vh] w-full">
        {/* Hero Image */}
        <Image
          src="/hero.png"
          alt="Hero Background"
          ...
          <div className="text-center text-white">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-8 text-white/80">
              {[{ icon: Globe, label: "50+ Countries", value: "Covered" },
                ...
                { icon: Shield, label: "Trusted", value: "Sources" }].map((stat, index) => (
            ...
            <div className="mt-12 flex flex-wrap justify-center items-center gap-6 opacity-80">
              ...
              <div className="flex items-center gap-4">
                {["BBC", "CNN", "Al Jazeera", "Reuters"].map((source) => (
                  <div key={source} className="text-xs font-medium bg-white/5 px-3 py-1 rounded-full">{source}</div>
                ))}
              </div>
            </div>
          </div>
